...
<div class="content layout-top-margin">
	...
	<form:form modelAttribute="roleViewModel" cssClass="form-horizontal my-form-margin-top">

		<div class="form-group">
			
			<label class="col-sm-1 my-label-form control-label">
			<spring:message code="app.role.name" /></label>
			
			<div class="col-sm-3">
				<form:input path="roleForm.name" cssClass="form-control" cssErrorClass="form-control error" />
				<form:errors path="roleForm.name" cssClass="error" />
			</div>
		...
		<div class="form-group">
			<div class="col-sm-offset-1 my-form-offset col-sm-2">
				...
				<input type="hidden" id="roleForm.idRole" name="roleForm.idRole" value="${roleViewModel.roleForm.idRole}" />
